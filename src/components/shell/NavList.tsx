...
import {
  ...
  Inbox, FileDown, Send, Copy, Mail, BookOpen, Clock, Eye, ScanLine, Terminal, MessagesSquare, UserCheck, Bug, type LucideIcon,
} from 'lucide-react';
...
const NAV_ICONS: Record<string, LucideIcon> = {
  ...
  BookOpen, Clock, Eye, ScanLine, Terminal, MessagesSquare, UserCheck, Bug,
};
