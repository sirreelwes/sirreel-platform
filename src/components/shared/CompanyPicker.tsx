  ...
  return (
    <div className="relative" ref={wrapperRef}>
      <input
        ...
        // Colours stated, not inherited: this is the other box a rep types
        // a production company into, so it is the other one iOS AutoFill
        // offers a contact's organisation for — and an uncoloured field is
        // the one the platform repaints (see globals.css, 2026-09-19).
        className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm bg-white text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-gray-400"
      />
