...
export const LCDW_TERMS: { heading: string; text: string }[] = [
  { heading: '1. Nature of this Agreement.', text: `The agreement is between you and SirReel Production Vehicles, Inc. DBA SirReel Studio Rentals (SIRREEL). SirReel rents to You the vehicle identified on the Rental Record ("Vehicle") subject to the Rental Record and these Terms and Conditions. You and Authorized Drivers: (a) are not agents of SirReel; (b) may not transfer the Vehicle or any rights or obligations under this Agreement; or (c) may not service or repair the Vehicle without SirReel's prior express approval. SIRREEL MAKES NO EXPRESS OR IMPLIED WARRANTY OF MERCHANTABILITY OR THAT THE VEHICLE IS FIT FOR ANY PARTICULAR PURPOSE.` },
  { heading: '2. Who may Drive the Vehicle.', text: `Only You, and with Your permission, Your spouse, employer and coworkers incidental to their business with You, and persons listed as Additional Drivers may drive the Vehicle. All Authorized Drivers must be at least 25 years old and have a valid driver's license.` },
  { heading: '3. Vehicle Returns.', text: `You must return the Vehicle in the same condition as when received (except for ordinary wear) to SirReel's location on the day and time specified. In no event may You keep the Vehicle for more than thirty (30) days. Failure to return the Vehicle when due terminates SirReel's permission to use the Vehicle.` },
  { heading: '4. Responsibility for Loss of or Damage to the Vehicle.', text: `Regardless of fault, You are responsible for the loss of or damage to the Vehicle except for ordinary wear. (b) If You purchase the Limited Collision Damage Waiver (LCDW) (which is not insurance) at the beginning of the rental, SirReel will not hold You responsible for the first $1,000 in loss of or damage to the Vehicle (including loss of use, towing, storage, impound, and administrative charges) except: (1) when theft occurs or (2) if the Vehicle is used as prohibited in Paragraph 5.` },
  { heading: '5. Prohibited Uses of the Vehicle.', text: `You and Authorized Drivers may NOT permit the Vehicle to be driven: (a) by anyone under the influence of alcohol or drugs; (b) outside the United States, off road, to tow or push anything without prior written permission; (c) to transport persons for compensation or in any speed test; (d) in connection with conduct that could be charged as a felony; (e) in a willful, wanton, or reckless manner; (f) if obtained by fraudulent statements; (g) to transport hazardous or explosive substances; (h) without using seatbelts; (i) in connection with any illegal conduct.` },
  { heading: '6. Payment of Charges.', text: `You will pay SirReel on demand all amounts incurred including: (a) a refueling charge at $10.00/gallon if You return the Vehicle with less fuel than received; (b) all fines, penalties, and attorney's fees unless due to SirReel's fault; (c) all charges related to loss or damage to the Vehicle; (d) all time and mileage charges as computed on the Rental Record.` },
  { heading: '7. Accidents, Theft, Vandalism and Claim Reporting.', text: `You must immediately report any accident, theft, or vandalism to SirReel and to the police. You must promptly deliver to SirReel any papers relating to such incident. FAILURE TO COOPERATE MAY VOID ANY LIABILITY INSURANCE COVERAGE AND ANY LIMITATION OF YOUR RESPONSIBILITY FOR LOSS OF OR DAMAGE TO THE VEHICLE.` },
  { heading: '8. Personal Property.', text: `SirReel is not responsible for loss or damage to Your personal property left in or about the Vehicle.` },
  { heading: '9. Additional Terms.', text: `Any modification of this Agreement is null and void unless in writing signed by You and SirReel. If any part of this Agreement is held void or unenforceable, the validity of the remaining parts shall not be affected.` },
  { heading: '10. Liability Insurance and Indemnity.', text: `You warrant that you have and will maintain automobile liability insurance with limits equal to or greater than those required by law. In the event of an accident, your insurance shall be primary and Non-Contributory.` },
  { heading: '11. Loss of Use.', text: `In the event of damage or destruction of a vehicle, you will pay for loss of use without regard to fleet utilization, plus an administrative fee, plus towing and storage charges.` },
...
/**
 * The eligibility sentence a client reads before electing LCDW, and the
 * text `src/lib/pricing/lcdwEligibility.ts` is the executable form of.
 * When the two disagree, THIS wins and the module is the bug.
 *
 * Wardrobe and Hair/Makeup Trailers added 2026-09-10 (Wes). They were
 * already excluded in fact — they are Specialty Vehicles, and the first
 * sentence limits the waiver to fleet rental vehicles — but the class's
 * examples named the coaches and restroom trailers and not these, and
 * "such as" is a poor place to leave a client guessing about coverage.
 */
export const LCDW_ELIGIBILITY_NOTE = `** LCDW is ONLY available for fleet rental vehicles such as: Cube Trucks, Cargo Vans, Stake Bed Trucks. Specialty Vehicles such as Motorhomes, Combos, PopVans, VTR/PeopleMover Vans, Restroom Trailers, Wardrobe Trailers, Hair/Makeup Trailers, Scissor Lifts, Golf Carts or any vehicle requiring a commercial driver's license are NOT ELIGIBLE for LCDW.`
...
export const STUDIO_TERMS: { heading: string; text: string }[] = [
  ...
  { heading: '2. Description.', text: `Producer shall have the right to use the Sets including furniture and fixtures located on or about the Sets.` },
  { heading: '3. Fees, Term and Re-Entry.', text: `Producer may use the Property on the dates specified. Re-entry within 60 days requires 5 days advance written notice and is subject to availability.` },
  { heading: '4. Use, Protection and Restoration.', text: `No smoking, eating or drinking on Sets. No alcohol or illegal drugs. No nudity without written consent. Layout board recommended under all equipment. Producer shall remove all personnel and equipment by end of Term.` },
  { heading: '5. Fees.', text: `Location Fee is due in advance for each day. All additional rentals including Grip, Lighting, and Production Supplies must be contracted through SirReel Studios unless otherwise agreed.` },
  { heading: '6. Utilities.', text: `Producer agrees to pay for any necessary unclogging, pumping or damages to bathrooms caused by misuse.` },
  { heading: '7. Security Deposit.', text: `Producer agrees to pay 100% of the Location Fee as a Security Deposit. The deposit will be deducted from the final bill.` },
  { heading: '8. Time of Payment.', text: `Total Due and Security Deposit must be paid prior to commencement of Term.` },
  { heading: '9. Dark Days.', text: `Any day on which set dressing is left on the Property with no production personnel present. Access during a Dark Day converts it to a Prep, Shoot, or Strike Day.` },
  { heading: '10. Postponement/Cancellation Policy.', text: `All cancellations must be made one week prior to start date. Cancellations inside one week will be billed the full rental rate.` },
  { heading: '12. Products Release.', text: `SirReel has secured rights to use identified products on Standing Sets. Producer may utilize these materials for the Production.` },
  { heading: '13. Production Ownership.', text: `Producer shall be the sole and exclusive owner of all rights in photographs, film, video and sound recordings made pursuant to this Agreement.` },
