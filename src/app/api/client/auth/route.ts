    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:480px;margin:0 auto;padding:24px;">
          <div style="background:#1a1a1a;padding:20px;border-radius:12px 12px 0 0;text-align:center;">
          ...
          <div style="background:white;padding:24px;border:1px solid #e5e7eb;border-radius:0 0 12px 12px;">
            ...
            <a href="${loginUrl}" style="display:block;background:#1a1a1a;color:white;padding:14px;border-radius:8px;text-decoration:none;text-align:center;font-weight:bold;font-size:15px;">
              View My Jobs &rarr;
            </a>
