...
const TERMS = [
  ...
  { n: 29, title: 'Non-smoking Policy', text: `All vehicles are non-smoking. A ${usd(SMOKING_FEE_PER_DAY)} per day fee may be charged in addition to repair costs if the smoking policy is not observed.` },
];
      ...
      <div className="max-w-2xl mx-auto px-4 py-5 space-y-4">
        ...
        {activeTab === 'overview' && (
          <div className="pb-2 px-1 space-y-2">
            {/* Our W-9 — clients need it for their AP/records when they pay
                us. Shared single company file via /api/public/forms/w9 (same
                one the public site's Forms → W-9 serves). */}
            <a href="/api/public/forms/w9" target="_blank" rel="noopener noreferrer"
