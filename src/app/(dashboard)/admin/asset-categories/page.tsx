...
const DEPT_BADGE: Record<string, string> = {
  ...
  PHOTO_SHOOT: "bg-chip-neutral-bg text-chip-neutral-fg",
};
const DEPT_LABEL: Record<string, string> = {
  VEHICLES: "Vehicles", STAGES: "Stages", PRO_SUPPLIES: "Pro Supplies",
  COMMUNICATIONS: "Communications", GE: "Grip & Electric", EXPENDABLES: "Expendables", ART: "Art", WARDROBE_MAKEUP: "Wardrobe & Makeup", PHOTO_SHOOT: "Photo Shoot",
};
const DEPT_ORDER = ["VEHICLES", "STAGES", "PRO_SUPPLIES", "WARDROBE_MAKEUP", "PHOTO_SHOOT", "COMMUNICATIONS", "GE", "EXPENDABLES", "ART"];
