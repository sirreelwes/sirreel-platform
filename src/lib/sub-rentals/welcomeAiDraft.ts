...
export async function draftFromPrompt(a: {
  ...
  const facts = [
    ...
    `His stance on the terms: all of this has to work for both parties. SirReel is talking with a FEW companies and is choosing the best fit — the email must not read as if all they need to do is agree; it asks how they would approach it.`,
