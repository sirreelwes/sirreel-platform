          ...
          <tr>
            <td align="center" style="background-color: ${HEADER_BG}; padding: 36px 24px 28px; text-align: center;">
              ${/* Wordmark top centre at 200px over the accent rule — the
                   welcome-family header (Wes 2026-09-06), inline in a
                   centred cell because Gmail ignores auto margins on a
                   display:block image. JS comment so it never reaches the
                   inbox. */ ''}<img src="https://hq.sirreel.com/sirreel-logo-white.png" alt="SirReel Studio Services" width="200" style="display: inline-block; max-width: 200px; width: 200px; height: auto; border: 0; outline: none; text-decoration: none;" />
