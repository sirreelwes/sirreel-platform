...
import type { VendorAgreementKind } from './vendorAgreementClauses'
...
export async function generateVendorAgreementPdf(args: { partner: VendorAgreementPartyForRender; kind?: VendorAgreementKind; generatedAt?: Date }): Promise<Buffer> {
